		...
		<?php
		            $product_id = $_product_id; // Or use your variable
                                ...
                                if ( $product->is_type('variable') ) {
                                    ...
                                    echo '<a style="font-size:13px; padding: 5px 9px 5px 9px;" href="#" class="button yith-wcqv-button quick_view_upsell button" data-product_id="' . esc_attr($product_id) . '">+ ΠΡΟΣΘΕΤΩ</a>';
                                } else {
