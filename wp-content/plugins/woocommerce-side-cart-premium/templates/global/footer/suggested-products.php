		...
		<?php
		            $product_id = $_product_id;
                                ...
                                if ( $product->is_type('variable') ) {
                                    ...
                                    echo '<a style="font-size:13px; padding: 5px 9px 5px 9px;" href="#" class="button noriks-upsell-btn" data-product_id="' . esc_attr($product_id) . '" data-vdata="' . esc_attr(json_encode($vdata)) . '">+ ΠΡΟΣΘΗΚΗ</a>';
                                } else {
                                    echo '<a style="font-size:13px; padding: 5px 9px 5px 9px;" href="' . esc_url($product->add_to_cart_url()) . '" class="button add_to_cart_button ajax_add_to_cart" data-product_id="' . esc_attr($product_id) . '" data-quantity="1">+ ΠΡΟΣΘΗΚΗ</a>';
                                }
    			        ?>
