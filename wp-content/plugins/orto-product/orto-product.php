...
function gck_render_bundle_selector() {
    ...
    if (  !has_term( array( 'orto-starter', 'orto', 'orto-boxer-gr', 'orto-ortopas', 'orto-bunion', 'orto-fisiorest', 'orto-norikshers', 'orto-noriks-hers', 'orto-majica-darila' ), 'product_cat', $product_id )  )   :
    ?>
        <style>
