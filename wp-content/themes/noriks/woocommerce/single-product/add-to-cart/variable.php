		...
		<table class="variations" cellspacing="0" role="presentation">
			<tbody>
				...
				//	var_dump($attribute_name);
						...
						if ( $attribute_name == 'Choose your size' ||  $attribute_name == 'Size' || $attribute_name == 'Velikost'  || $attribute_name == 'Velikost trička' || $attribute_name == 'Μέγεθος' || $attribute_name == 'μέγεθος-mployzakia' || $attribute_name == 'Μέγεθος μπλουζάκια' || $attribute_name == 'Επιλέξτε μέγεθος' )     {
