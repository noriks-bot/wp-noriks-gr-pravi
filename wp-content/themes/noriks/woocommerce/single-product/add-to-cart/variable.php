...
<form class="variations_form cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint( $product->get_id() ); ?>" data-product_variations="<?php echo $variations_attr; // WPCS: XSS ok. ?>">
		...
		<table class="variations" cellspacing="0" role="presentation">
			<tbody>
				...
				//	var_dump($attribute_name);
						...
						if ( $attribute_name == 'Choose your size' ||  $attribute_name == 'Size' || $attribute_name == 'Velikost'  || $attribute_name == 'Velikost trička' || $attribute_name == 'Μέγεθος' || $attribute_name == 'μέγεθος' || $attribute_name == 'μέγεθος-mployzakia' || $attribute_name == 'Μέγεθος μπλουζάκια' || $attribute_name == 'Επιλέξτε μέγεθος' )     {
    ...
    vertical-align: middle;" xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
      ...
      </svg>Πίνακας μεγεθών</a>';
                        }
						?>
						
						
						<?php
							if (  $attribute_name == 'Velikost boxerek' || $attribute_name == 'Μέγεθος μποξεράκια' || $attribute_name == 'μέγεθος-mpoxer' || $attribute_name == 'Μέγεθος μπόξερ' )     {
