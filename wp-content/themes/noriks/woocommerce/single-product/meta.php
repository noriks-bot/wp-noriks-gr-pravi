 ...
 <div class="accordion">
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-content">
        ...
        <p>Το KidsNest στο μέγεθος <strong>9–14 ετών</strong> είναι φτιαγμένο για μεγαλύτερο κεφάλι, αυχένα και ώμους. Διαφορετικό περίγραμμα, άλλο ύψος, άλλη στήριξη. Ίδιος βασικός μηχανισμός: σωστή ευθυγράμμιση κεφαλιού, αυχένα και γνάθου, όλη τη νύχτα, σε ένα σώμα που ακόμη μεγαλώνει.</p>
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-content">
         ...
         <?php elseif( function_exists('noriks_is_type') && noriks_is_type('kneeheat', $current_product_id) ): ?>
                ...
                Το <strong>NORIKS KneeHeat</strong> είναι περιτύλιγμα γονάτου που συνδυάζει τρεις θεραπείες σε μία συνεδρία: θερμότητα έως 42 °C, συμπίεση με αέρα και μασάζ με δόνηση 60 Hz. Η θερμότητα διαστέλλει τα αιμοφόρα αγγεία και διευκολύνει τη ροή του αίματος προς τους βαθύτερους ιστούς, η ρυθμική συμπίεση απομακρύνει το συσσωρευμένο υγρό και η δόνηση χαλαρώνει τη δυσκαμψία γύρω από την άρθρωση.<br><br>Η συνεδρία διαρκεί 12 λεπτά και ξεκινά με ένα κουμπί — χωρίς εφαρμογή, χωρίς ρυθμίσεις και χωρίς καλώδιο. Διαθέτει 3 επίπεδα θερμότητας και 3 λειτουργίες δόνησης, ώστε να προσαρμόζετε την ένταση στη μέρα και στις ενοχλήσεις σας.<br><br>Το περιτύλιγμα έχει εργονομικό σχήμα και στερεώνεται με ρυθμιζόμενους ιμάντες· ταιριάζει στο αριστερό και στο δεξί γόνατο, ενώ στη συσκευασία υπάρχει και ιμάντας προέκτασης για μεγαλύτερες περιφέρειες. Το ύφασμα που ακουμπά στο δέρμα είναι μαλακό και διαπνέον.<br><br>Η συσκευή φορτίζει με το καλώδιο USB-C που περιλαμβάνεται και μία φόρτιση αρκεί για πολλές συνεδρίες. Μαζί της λαμβάνετε 2 χρόνια εγγύηση αντικατάστασης.
         ...
         <?php elseif( function_exists('noriks_is_type') && noriks_is_type( 'kidsnest', $current_product_id ) ): ?>
                ...
                Το NORIKS KidsNest είναι κατασκευασμένο από υποαλλεργικό αφρό μνήμης με πιστοποίηση OEKO-TEX® — χωρίς φορμαλδεΰδη, βαρέα μέταλλα και BPA — με θήκη από διαπνέουσα πλέξη.<br><br>Η εργονομική δομή 3 ζωνών αγκαλιάζει απαλά το κεφάλι, στηρίζει τον αυχένα και βοηθά να διατηρείται η σπονδυλική στήλη σε φυσική ευθυγράμμιση — ακόμη κι όταν το παιδί στριφογυρίζει πολύ τη νύχτα. Έτσι ενθαρρύνει την αναπνοή από τη μύτη και πιο ήρεμο, βαθύτερο ύπνο.<br><br>Διαθέσιμο σε τρία μεγέθη (1–3, 3–9 και 9–14 ετών), μεγαλώνει μαζί με το παιδί σας και προσφέρει το σωστό ύψος στήριξης σε κάθε στάδιο ανάπτυξης.
