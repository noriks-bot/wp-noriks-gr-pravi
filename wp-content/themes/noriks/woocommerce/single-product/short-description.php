...
<div class="nhs-usp">
  <div class="nhs-usp-guarantee"><svg width="15" height="15" viewBox="0 0 24 24" style="flex:0 0 auto;"><circle cx="12" cy="12" r="12" fill="#7c3aed"/><path d="M7 12.5l3 3 7-7" fill="none" stroke="#fff" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg> Εγγύηση επιστροφής χρημάτων 30 ημερών</div>
  <div class="nhs-usp-grid">
    <div><span class="nhs-usp-ic">≈</span> Μειώνει τις ρυτίδες</div>
    <div><span class="nhs-usp-ic">↓</span> Μειώνει τις λεπτές γραμμές</div>
    <div><span class="nhs-usp-ic">♡</span> Ξεθωριάζει τις ουλές μέσα στη νύχτα</div>
    <div><span class="nhs-usp-ic">✚</span> Έξτρα κολλητικό</div>
    <div><span class="nhs-usp-ic">✓</span> Επαναχρησιμοποιήσιμο και ανθεκτικό</div>
    <div><span class="nhs-usp-ic">↗</span> Ενισχύει την παραγωγή κολλαγόνου</div>
  </div>
</div>
<style>
...
<div class="kn2-badge">
  ...
  <span>Συστήνεται από παιδιάτρους</span>
</div>
<div class="kn2-below">
  <div class="kn2-trust">
    <span><svg width="16" height="16" viewBox="0 0 24 24"><path d="M12 2l8 3v6c0 5-3.5 9.5-8 11-4.5-1.5-8-6-8-11V5l8-3z" fill="#2b3fb0"/><path d="M8.5 12l2.5 2.5 4.5-4.5" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> 90 νύχτες δοκιμής</span>
    <span><svg width="18" height="14" viewBox="0 0 24 18"><rect x="1" y="3" width="13" height="10" rx="1.5" fill="#2b3fb0"/><path d="M14 6h4l4 4v3h-8z" fill="#2b3fb0"/><circle cx="6" cy="15" r="2.4" fill="#1b2450"/><circle cx="18" cy="15" r="2.4" fill="#1b2450"/></svg> Γρήγορη παράδοση</span>
    <span><svg width="17" height="15" viewBox="0 0 24 20"><rect x="3" y="2" width="18" height="11" rx="2" fill="none" stroke="#2b3fb0" stroke-width="2"/><circle cx="12" cy="7.5" r="2.6" fill="#2b3fb0"/><path d="M2 17c3 2 7 3 10 3s7-1 10-3" fill="none" stroke="#2b3fb0" stroke-width="2" stroke-linecap="round"/></svg> Πληρωμή και με αντικαταβολή</span>
  </div>
  <div class="kn2-redbox">
    <p class="kn2-red-title"><svg width="14" height="13" viewBox="0 0 24 22" style="vertical-align:-2px;margin-right:6px;"><path d="M12 1L23 21H1L12 1z" fill="none" stroke="#c0452f" stroke-width="2.4" stroke-linejoin="round"/><path d="M12 8v6" stroke="#c0452f" stroke-width="2.4" stroke-linecap="round"/><circle cx="12" cy="17.4" r="1.3" fill="#c0452f"/></svg>ΓΙΑ ΓΟΝΕΙΣ ΠΑΙΔΙΩΝ ΚΑΤΩ ΤΩΝ 9 ΕΤΩΝ</p>
    <p class="kn2-red-body">Κάθε νύχτα σε λάθος μαξιλάρι <strong class="kn2-red">το πρόσωπο του παιδιού σας διαμορφώνεται — προς τη λάθος κατεύθυνση.</strong> Σάλια. Ροχαλητό. Ανοιχτό στόμα. Έως τα <strong class="kn2-red">9</strong> οι αλλαγές παγιώνονται. Έως τα <strong class="kn2-red">14</strong> — ακριβά σιδεράκια. Έως τα <strong class="kn2-red">18</strong> — συζήτηση για σοβαρότερες επεμβάσεις. Οι παιδιατρικοί οδοντίατροι αεραγωγών το βλέπουν καθημερινά — έπαψαν να το λένε σπάνιο. <strong class="kn2-red">Αλλάξτε μαξιλάρι απόψε.</strong></p>
  </div>
</div>
<style>
  /* Badge iznad naslova */
...
(function(){
  function init(){
    ...
    /* Ribboni: strip ogenj + dodaj "Καλύτερη αξία" na 3. karto */
    document.querySelectorAll('.gck-popular-badge, .gck-popular-badge-2').forEach(function(b){ b.textContent=b.textContent.replace('🔥','').trim(); if(/δημοφιλές/i.test(b.textContent)) b.textContent='Πιο δημοφιλές'; });
    ...
    if(cards.length>=3 && !cards[2].querySelector('.kn2-ribbon') && !cards[2].querySelector('.gck-popular-badge, .gck-popular-badge-2')){
      var rb=document.createElement('div'); rb.className='kn2-ribbon'; rb.textContent='Καλύτερη αξία'; cards[2].appendChild(rb);
    }
...
<div class="oj-recpill">
  <img src="<?php echo esc_url( get_template_directory_uri().'/img/ortopedski-jastuk/04_lijecnik_HR.png' ); ?>" alt="Γιατρός" class="oj-recpill-av" onerror="this.style.display='none'">
  <span><strong>Συνιστάται από τον Δρ. Παπαδόπουλο</strong>&nbsp;|&nbsp;<em>Ειδικό σπονδυλικής στήλης</em></span>
...
<div class="oj-stockpill">
  ...
  <em>Έχουν απομείνει μόνο λίγα κομμάτια!</em>
</div>
...
<div class="oj-orders">
  ...
  <em><strong>128 παραγγελίες</strong> τις τελευταίες <strong>24 ώρες!</strong></em>
</div>
<style>
...
<div class="ncl-trust">
  <span>Για πεντακάθαρα τζάμια και ντουζιέρες,</span>
  <span class="ncl-trust-stars">★★★★★</span>
  <span>μας εμπιστεύονται 138.452+ νοικοκυριά</span>
</div>
<style>
