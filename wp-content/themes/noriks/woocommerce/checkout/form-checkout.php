              ...
              <label for="shipping_method_0_standard_custom" class="checkedlabel">
                ...
                <div class="outer-wrapper">
                  ...
                  <div class="inner-wrapper-img">
                    <span class="shipping_method_delivery_price tag tag--red"><?php $ship = (float) WC()->cart->get_shipping_total(); echo $ship > 0 ? wc_price($ship) : 'Δωρεάν'; ?></span>
                    <span class="delivery_img"><img decoding="async" class="elta_courier standard" src="https://images.vigo-shop.com/general/curriers/acs.png"/></span>
                  </div>
                </div>
              </label>
            </li>
...
<div class="checkout-warranty flex flex--center flex--middle">
  ...
  <div class="flex__item--autosize f--m checkout-warranty__text">
    <strong>Αγοράστε χωρίς ανησυχία </strong><br>Επιστροφή χρημάτων εντός 30 ημερών
  </div>
</div>
...
<div class="agreed_terms_txt">
  ...
  <div class="terms-checkbox-and-links">
    ...
    Διάβασα και αποδέχομαι <a href="#" id="terms_conditions_link">τους Γενικούς Όρους Πώλησης</a> και <a href="#" id="withdrawal_policy_link">το δικαίωμα υπαναχώρησης</a>.
  </div>
</div>
...
jQuery(function($){
  ...
  var now=new Date(),from=addBiz(now,3),to=addBiz(now,4);
