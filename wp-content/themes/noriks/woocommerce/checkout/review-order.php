...
<div class="noriks-order-summary woocommerce-checkout-review-order-table">
  <div class="review-all-products-container">
    <div class="vigo-checkout-total__content">
      ...
      <div class="c--darkgray review-section-container review-addons shipping_order_review">
        ...
        <div class="review-addons-price review-sale-price" id="noriks-shipping-price"><span style="display:inline-block;padding:3px 10px;border-radius:5px;background:#9ce79c;color:#228b22;font-size:14px;font-weight:500;">Δωρεάν</span></div>
      </div>
      ...
      <div class="c--darkgray review-section-container review-addons">
        <div class="review-addons-title"><div>Κουπόνι: <?php echo esc_html( strtoupper($code) ); ?></div></div>
  ...
  <div class="vigo-checkout-total__sum flex flex--middle border_price">
    <div class="flex__item f--l">
      Σύνολο: <span class="f--bold price_total_wrapper"><?php wc_cart_totals_order_total_html(); ?></span>
    </div>
  </div>
</div>
