...
<div class="nmn">
  <div class="nmn-wrap">
    ...
    <p class="nmn-sub">Κατεβάστε τις οδηγίες για το προϊόν σας NORIKS σε μορφή PDF.</p>
    ...
    <div class="nmn-search">
      ...
      <input type="search" id="nmn-q" placeholder="Αναζήτηση με το όνομα προϊόντος…" autocomplete="off">
    </div>
          ...
          <div class="nmn-body">
            ...
            <p class="nmn-links">
              <a class="nmn-btn" href="<?php echo esc_url( $dir_url . $m['file'] ); ?>" target="_blank" rel="noopener">
                Λήψη PDF <span>(<?php echo esc_html( $size ); ?>)</span>
              </a>
              <?php if ( $p['url'] ) : ?>
                <a class="nmn-link" href="<?php echo esc_url( $p['url'] ); ?>">Σελίδα προϊόντος</a>
              <?php endif; ?>
            </p>
          </div>
        </div>
    ...
    <p class="nmn-empty" id="nmn-empty" hidden>Δεν υπάρχουν οδηγίες για αυτόν τον όρο. Γράψτε μας στο <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
    <p class="nmn-help">Χρειάζεστε βοήθεια με το προϊόν; Γράψτε μας στο <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
  </div>
</div>
