 ...
 *
 * Poleg tega stevilko ob oddaji naročila tiho pretvori v mednarodno obliko (+30...),
...
define( 'NORIKS_TEL_EXAMPLE', '6912345678' );

/** Sporocilo ob napacni stevilki — eno samo mesto za ves trg. */
function noriks_tel_message() {
    return 'Ελέγξτε τον αριθμό τηλεφώνου — φαίνεται ελλιπής. π.χ. ' . NORIKS_TEL_EXAMPLE;
}
