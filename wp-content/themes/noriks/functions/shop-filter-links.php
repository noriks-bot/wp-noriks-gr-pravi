...
function noriks_shop_filter_map() {
	return apply_filters( 'noriks_shop_filter_map', array(
		'__shop__' => array(
			'dimofili' => 'Δημοφιλή',
			'megala-paketa' => 'Μεγάλα πακέτα',
			'paketo-ekkinisis' => 'Πακέτο εκκίνησης',
		),
		'kaltses' => array(
			'kaltses-lefko' => 'Λευκό',
			'kaltses-mavro' => 'Μαύρο',
		...
		'mplouzoakia' => array(
			'mplouzoakia-1-tem' => '1 τεμ',
			'mplouzoakia-paketo-3-tem' => 'Πακέτο 3 τεμ',
			'mplouzoakia-paketo-6-tem' => 'Πακέτο 6 τεμ',
			'mplouzoakia-paketo-9-tem' => 'Πακέτο 9 τεμ',
			'mplouzoakia-paketo-12-tem' => 'Πακέτο 12 τεμ',
			'mplouzoakia-paketo-15-tem' => 'Πακέτο 15 τεμ',
			'mplouzoakia-mavro' => 'Μαύρο',
			'mplouzoakia-polychromo' => 'Πολύχρωμο',
		),
		'mpoxer' => array(
			'mpoxer-1-tem' => '1 τεμ',
			'mpoxer-paketo-3-tem' => 'Πακέτο 3 τεμ',
			'mpoxer-paketo-5-tem' => 'Πακέτο 5 τεμ',
			'mpoxer-paketo-7-tem' => 'Πακέτο 7 τεμ',
			'mpoxer-paketo-10-tem' => 'Πακέτο 10 τεμ',
			'mpoxer-paketo-15-tem' => 'Πακέτο 15 τεμ',
			'mpoxer-mavro' => 'Μαύρο',
			'mpoxer-polychromo' => 'Πολύχρωμο',
		),
		'set' => array(
			'set-2-mplouzoakia-5-mpoxer' => 'Σετ: 2 μπλουζάκια + 5 μπόξερ',
			'set-4-mplouzoakia-10-mpoxer' => 'Σετ: 4 μπλουζάκια + 10 μπόξερ',
			'set-5-mplouzoakia-5-mpoxer' => 'Σετ: 5 μπλουζάκια + 5 μπόξερ',
		)
	) );
}
