 ...
 *   GR  mplouzoakia-paketo-6-tem  (goneas: mplouzoakia)
...
function noriks_render_pack_switcher() {
    ...
    <div class="npk">
        ...
        <?php if ( $shown > 1 ) : ?>
        <div class="npk-block">
            <div class="npk-label"><?php esc_html_e( 'Επίλεξε πακέτο', 'noriks' ); ?></div>
                    ...
                    <a class="npk-size<?php echo $is_cur ? ' is-active' : ''; ?>"
                       ...
                       <?php echo $is_cur ? 'aria-current="true"' : ''; ?>>
                        <span class="npk-size-n"><?php
                            if ( (int) $s === 1 ) {
                                esc_html_e( '1 τεμ.', 'noriks' );
                            } else {
                                echo (int) $s; ?> <?php esc_html_e( 'τεμ.', 'noriks' );
                            } ?></span>
                        <span class="npk-size-p"><?php echo wp_kses_post( wc_price( $ppu ) ); ?><span class="npk-size-u"><?php esc_html_e( '/ τεμ.', 'noriks' ); ?></span></span>
                    </a>
                <?php endforeach; ?>
            </div>
        ...
        <?php if ( count( $same ) > 1 ) : ?>
        <div class="npk-block">
            <div class="npk-label"><?php esc_html_e( 'Χρώμα', 'noriks' ); ?></div>
            <div class="npk-scroll">
