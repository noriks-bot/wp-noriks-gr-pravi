...
const NORIKS_FLASH_CAT   = 'kalokairines-ekptoseis';
...
function noriks_flash_deals_banner() {
    ...
    ?>
    <div class="nfd" role="region" aria-label="Καλοκαιρινές εκπτώσεις">
      <div class="nfd-in">
        <div class="nfd-left">
          <p class="nfd-eyebrow">Εποχιακή έκπτωση</p>
          <div class="nfd-head">
            <h2 class="nfd-title">Καλοκαιρινές εκπτώσεις</h2>
            <?php if ( $off > 0 ) : ?>
              <span class="nfd-badge">-&minus;<?php echo (int) $off; ?>%</span>
            <?php endif; ?>
          </div>
          <p class="nfd-sub">Μέχρι εξαντλήσεως αποθεμάτων</p>
        </div>

        <div class="nfd-right">
          <span class="nfd-cta">Η προσφορά λήγει σε</span>
          <div class="nfd-clock" id="nfd-clock" aria-live="off">
            <span class="nfd-unit"><b data-u="d">00</b><em>ημ</em></span>
            <span class="nfd-unit"><b data-u="h">00</b><em>ώρες</em></span>
            <span class="nfd-unit"><b data-u="m">00</b><em>λεπ</em></span>
            <span class="nfd-unit"><b data-u="s">00</b><em>δευτ</em></span>
          </div>
        </div>
      </div>
    </div>
