...
function noriks_handle_add_upsell() {
    ...
    $is_majice = ( strpos($cat_str, 'orto-majic') !== false || strpos($cat_str, 'mplouzoakia') !== false || strpos($name, 'μπλουζ') !== false || strpos($cat_str, 'majic') !== false || strpos($name, 'majic') !== false );
