	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			array(
				...
				'label'        => 'Εμφάνιση upsell κάτω από το κουμπί (3x Μπλε μπόξερ)',
				'name'         => 'noriks_pp_upsell',
				'type'         => 'true_false',
				'instructions' => 'Προσθέτει το πλαίσιο "Αγοράστε μαζί και εξοικονομήστε" ακριβώς κάτω από το κουμπί Προσθήκη στο καλάθι. Ο πελάτης επιλέγει μέγεθος και 3 τεμάχια προστίθενται στην τιμή upsell. Ισχύει μόνο για αυτό το προϊόν.',
				'ui'           => 1,
			),
		),
		'location'   => array(
