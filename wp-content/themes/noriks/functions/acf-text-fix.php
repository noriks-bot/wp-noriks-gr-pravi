...
add_filter( 'acf/load_value', function ( $value, $post_id, $field ) {
    ...
    $map = array(
        'singlepp_acc_h_3' => array( 'Απλές επιστροφές και δωρεάν ανταλλαγές' => 'Απλές επιστροφές και ανταλλαγές' ),
        'footer_top_text_3' => array( '4-8 εργάσιμες ημέρες' => '5-8 εργάσιμες ημέρες' ),
    );
