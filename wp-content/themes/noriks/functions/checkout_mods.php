...
function change_default_checkout_country() {
    return 'GR'; // Replace 'US' with your 2-letter country code
}
...
function custom_checkout_reorder_fields( $fields ) {
    ...
    if ( isset( $fields['billing']['billing_address_2'] ) ) {
        ...
        $fields['billing']['billing_address_2']['label'] = __( 'Αριθμός σπιτιού', 'your-textdomain' );
...
function add_contact_heading_before_email() {
    ...
    echo '<h3 class="checkout-section-title">Τα στοιχεία σας</h3>';
}
