...
function my_add_price_to_button_text( $text, $prod = null ) {
    ...
    if ( has_term( array( 'startovaci-balicek','orto', 'paketo-ekkinisis', 'starter-pack','orto-starter'  ), 'product_cat', $prod->get_id() ) ) {
        return $text;
    }
...
add_action( 'wp_footer', function () {
	...
	document.addEventListener('DOMContentLoaded', function () {
	  ...
	  if (!btn) return;
	  btn.textContent = 'Επιστροφή στην επιλογή';
...
function noriks_controlpro_atc_testimonial() {
    ...
    <div class="cpr-atc-rev">
        <img class="cpr-atc-avatar" src="<?php echo esc_url( $avatar ); ?>" alt="Ικανοποιημένος πελάτης NORIKS ControlPro" loading="lazy">
        <div class="cpr-atc-body">
            <p class="cpr-atc-text">«Μετά την επέμβαση προστάτη έκανα δύο χρόνια σταθερά ασκήσεις Kegel και δεν είδα ουσιαστική πρόοδο. Νόμιζα ότι θα φοράω σερβιέτες μια ζωή. Τέσσερις εβδομάδες με αυτή τη συσκευή και από 5 σερβιέτες την ημέρα έφτασα στο μηδέν.»</p>
