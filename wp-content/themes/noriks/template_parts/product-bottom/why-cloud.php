 ...
 *   1. Πάρτε πίσω τα πρωινά που θεωρούσατε χαμένα   11_jutra
 ...
 *   7. Δεν είναι όλα τα μαξιλάρια γονάτων ίδια                      05
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    ...
    <div class="ncd-copy">
      <h2 class="ncd-h2">Η διαφορά που φαίνεται από την πρώτη νύχτα</h2>
      <p><strong>Χωρίς μαξιλάρι:</strong> το πάνω πόδι πέφτει πάνω στο κάτω, η λεκάνη στρίβει και η πίεση πάει στη μέση και στα γόνατα.</p>
      <p><strong>Με το NORIKS Cloud:</strong> τα πόδια μένουν στη γραμμή των γοφών, το βάρος κατανέμεται και τα σημεία πίεσης εξαφανίζονται.</p>
      <ul class="ncd-check">
        <li>Γοφοί και γόνατα σε φυσική ευθυγράμμιση</li>
        <li>Λιγότερη πίεση στη μέση</li>
        <li>Λιγότερο στριφογύρισμα τη νύχτα</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-center">
    <h2 class="ncd-h2">Ξεκινήστε να κοιμάστε καλύτερα από απόψε</h2>
    <p class="ncd-sub">Απλό στη χρήση. <strong>Καλύτερος ύπνος</strong> από την πρώτη νύχτα.</p>
  </div>
  <div class="ncd-wrap">
      ...
      <?php foreach ( $cd_steps as $i => $st ) : ?>
        <div class="ncd-step4">
          <div class="ncd-step4-ic">
            ...
            <span class="ncd-step4-b">Βήμα <?php echo (int) $i + 1; ?></span>
          </div>
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-center">
    <h2 class="ncd-h2">Γιατί ξυπνάτε διαφορετικά με το NORIKS Cloud</h2>
    <p class="ncd-sub ncd-rate"><span class="ncd-stars">★★★★★</span> Βαθμολογία <strong>4,8/5</strong> χιλιάδες ικανοποιημένοι πελάτες</p>
  </div>
  <div class="ncd-wrap">
    <div class="ncd-revs">
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <p class="ncd-eyebrow">Ύπνος στο πλάι</p>
      <h2 class="ncd-h2">Πάρτε πίσω τα πρωινά που θεωρούσατε χαμένα</h2>
      <p>Ξέρετε την αίσθηση: ξυπνάτε πιασμένοι, όλη νύχτα ψάχνετε στάση που δεν πονάει ή ξυπνάτε αρκετές φορές χωρίς λόγο.</p>
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <h2 class="ncd-h2">Η ευθυγράμμιση που νιώθετε το πρωί</h2>
      ...
      <ul class="ncd-check">
        <li>Ευθυγραμμισμένη σπονδυλική στήλη αντί για στρεβλωμένη</li>
        <li>Ευθυγραμμισμένη λεκάνη χωρίς στρέψη</li>
        <li>Χωρισμένα γόνατα, χωρίς πίεση</li>
      </ul>
    </div>
...
<?php
$cd_cases = array(
  array( 'cld-case-bok.webp',       'Ύπνος στο πλάι', 'Prilagođeno vašem prirodnom položaju.' ),
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-center">
    <h2 class="ncd-h2">Σχεδιασμένο για ό,τι σας εμποδίζει να κοιμηθείτε</h2>
    <p class="ncd-sub">Έξι καταστάσεις όπου το μαξιλάρι γονάτων κάνει τη μεγαλύτερη διαφορά.</p>
  </div>
  <div class="ncd-wrap">
    <div class="ncd-cases">
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <h2 class="ncd-h2">Φτιαγμένο να αναπνέει</h2>
      <p>Αφρός μνήμης ιατρικής ποιότητας με ενσωματωμένες διατρήσεις — αρκετά σταθερός για να κρατά την απόσταση, αρκετά μαλακός για να προσαρμόζεται στο σώμα.</p>
      <ul class="ncd-check">
        <li><strong>Πλενόμενο κάλυμμα</strong> — αναπνέον ύφασμα, απαλό στο δέρμα</li>
        <li><strong>Οι διατρήσεις</strong> κρατούν τον αφρό δροσερό όλη τη νύχτα</li>
        <li><strong>Διατηρεί το σχήμα του</strong> για χρόνια, δεν πλακώνει</li>
      </ul>
    </div>
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-row2">
    ...
    <div class="ncd-copy">
      <h2 class="ncd-h2">Δεν είναι όλα τα μαξιλάρια γονάτων ίδια</h2>
      <ul class="ncd-vs">
        <li class="is-no"><strong>Χωρίς ιμάντα</strong><span>πέφτει μόλις γυρίσετε</span></li>
        <li class="is-no"><strong>Η κεντρική τρύπα</strong><span>εμποδίζει την κυκλοφορία</span></li>
        <li class="is-no"><strong>Πλακώνει</strong><span>μέσα σε λίγες εβδομάδες</span></li>
        <li class="is-yes"><strong>Ρυθμιζόμενος ιμάντας</strong><span>μένει ακριβώς εκεί που πρέπει</span></li>
        <li class="is-yes"><strong>Πλήρες, εργονομικό σχήμα</strong><span>χωρίς τρύπες και κενά</span></li>
        <li class="is-yes"><strong>Αφρός ιατρικής ποιότητας</strong><span>διατηρεί το σχήμα του για χρόνια</span></li>
      </ul>
    </div>
  </div>
</section>
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <h2 class="ncd-h2">Κατασκευασμένο με αυστηρά πρότυπα</h2>
      <p>Τα υλικά έχουν ελεγχθεί για επιβλαβείς ουσίες και ο αφρός είναι πιστοποιημένος. Ο σχεδιασμός ακολουθεί ελβετικά πρότυπα ποιότητας.</p>
      <ul class="ncd-check">
        <li><strong>OEKO-TEX® STANDARD 100</strong> — χωρίς επιβλαβείς ουσίες</li>
        <li><strong>CertiPUR-EU</strong> — πιστοποιημένος αφρός μνήμης</li>
        <li><strong>Σχεδιασμένο στην Ελβετία</strong>, κατασκευασμένο με ευρωπαϊκά πρότυπα</li>
      </ul>
    </div>
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <p class="ncd-eyebrow">Χωρίς ρίσκο</p>
      <h2 class="ncd-h2">60 νύχτες δοκιμής</h2>
      <p>Δοκιμάστε το μόνοι σας. Αν το NORIKS Cloud δεν είναι για εσάς, επιστρέφουμε ολόκληρο το ποσό — χωρίς όρους και χαρτιά.</p>
      <a class="ncd-cta" href="#bundle-selector">Παραγγείλτε το NORIKS Cloud</a>
    </div>
    <div class="ncd-media"><?php echo $cd_img('cld-60-noci.webp','60 νύχτες δοκιμής'); ?></div>
  </div>
</section>
