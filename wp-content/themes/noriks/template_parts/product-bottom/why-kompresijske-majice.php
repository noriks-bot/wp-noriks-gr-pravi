 ...
 * Ανδρικό φανελάκι συμπίεσης/διαμόρφωσης σιλουέτας. (GR translation of HR original.)
...
<section class="kmf-sec">
  <div class="kmf-wrap kmf-row2 kmf-rev">
    ...
    <div class="kmf-copy">
      <p class="kmf-eyebrow">Άμεσο αποτέλεσμα</p>
      <h2 class="kmf-h2">Διαμορφώνει τη σιλουέτα <em>μόλις το φορέσετε</em></h2>
      <p>Η στοχευμένη συμπίεση σφίγγει ομοιόμορφα την κοιλιά και τα πλευρά, εξομαλύνει τα «ψωμάκια» και ανορθώνει τη στάση του σώματος — χωρίς σφίξιμο που εμποδίζει την αναπνοή ή την κίνηση.</p>
      <ul class="kmf-check">
        <li>Επίπεδη κοιλιά και στήθος</li>
        <li>Πιο όρθια, δυναμική στάση</li>
        <li>Αόρατο κάτω από οποιοδήποτε πουκάμισο</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="kmf-sec kmf-alt">
  <div class="kmf-wrap kmf-row2">
    <div class="kmf-copy">
      ...
      <h2 class="kmf-h2">Πάρτε πίσω την αυτοπεποίθηση και τη δύναμή σας</h2>
      <p>Αν θέλετε τα ρούχα σας να σας εφαρμόζουν καλύτερα και να νιώθετε στήριξη όλη την ημέρα, το NORIKS FIT δημιουργήθηκε για εσάς.</p>
      <p>Κατασκευασμένο από <strong>ιοντικό ύφασμα συμπίεσης</strong>, προσφέρει εφαρμοστή, υποστηρικτική γραμμή που εξομαλύνει τη σιλουέτα και χαρίζει άνεση όλη την ημέρα — πιο κομψή εμφάνιση, καλύτερη επίγνωση της στάσης του σώματος και η αυτοπεποίθηση που έρχεται όταν νιώθετε καλά με αυτό που φοράτε.</p>
      <a class="kmf-cta" href="#bundle-selector">Διάλεξε το μέγεθός σου →</a>
    </div>
    <div class="kmf-media kmf-hero-media"><img src="<?php echo esc_url( $km.'hero.webp' ); ?>" alt="Φανελάκι συμπίεσης NORIKS FIT κάτω από πουκάμισο" loading="lazy"></div>
  </div>
</section>
...
<section class="kmf-sec">
  <div class="kmf-wrap">
    <h2 class="kmf-h2 kmf-center kmf-upper">Το νέο σας μυστικό όπλο κατά της κοιλιάς της μπύρας</h2>
    <div class="kmf-weapon-grid">
      <div class="kmf-feat-col">
        <div class="kmf-feat"><span class="kmf-feat-ic">✓</span><p>Αντίο «dad bod».</p></div>
        <div class="kmf-feat"><span class="kmf-feat-ic">✓</span><p>Κοιλιά της μπύρας; Εξαφανίστηκε.</p></div>
        <div class="kmf-feat"><span class="kmf-feat-ic">✓</span><p>Ψωμάκια; Κλειδωμένα.</p></div>
      </div>
      <div class="kmf-weapon-media"><img src="<?php echo esc_url( $km.'wear.webp' ); ?>" alt="Το NORIKS FIT διαμορφώνει την κοιλιά και τη σιλουέτα" loading="lazy"></div>
      <div class="kmf-feat-col">
        <div class="kmf-feat"><span class="kmf-feat-ic">✓</span><p>Στήθος; Λείο.</p></div>
        <div class="kmf-feat"><span class="kmf-feat-ic">✓</span><p>Αόρατο. Ασταμάτητο.</p></div>
        <div class="kmf-feat"><span class="kmf-feat-ic">✓</span><p>Το πουκάμισο εφαρμόζει. Επιτέλους.</p></div>
      </div>
    </div>
  </div>
</section>
...
<section class="kmf-sec">
  <div class="kmf-wrap kmf-row2">
    <div class="kmf-copy">
      <p class="kmf-eyebrow">Ορατή διαφορά</p>
      <h2 class="kmf-h2">Πριν και μετά το NORIKS FIT</h2>
      <p>Πιο όρθια στάση, επίπεδη κοιλιά και πιο κομψή σιλουέτα — μόλις το φορέσετε.</p>
      <ul class="kmf-check">
        <li>Εμφανώς πιο όρθια στάση</li>
        <li>Επίπεδη κοιλιά και «ψωμάκια»</li>
        <li>Πιο κομψή σιλουέτα κάτω από κάθε μπλούζα</li>
      </ul>
      <a class="kmf-cta" href="#bundle-selector">Διάλεξε το μέγεθός σου →</a>
    </div>
    <div class="kmf-media"><img src="<?php echo esc_url( $km.'prije-poslije.jpg' ); ?>" alt="Πριν και μετά το NORIKS FIT" loading="lazy"></div>
  </div>
</section>
...
<section class="kmf-sec kmf-alt">
  <div class="kmf-wrap">
    <h2 class="kmf-h2 kmf-center">Γιατί NORIKS FIT;</h2>
    <p class="kmf-sub">Συγκρίνετε το NORIKS FIT με τα συνηθισμένα φανελάκια συμπίεσης και δείτε τη διαφορά που νιώθετε μόλις το φορέσετε.</p>
    <div class="kmf-cmp-row">
      <div class="kmf-cmp-media"><img src="<?php echo esc_url( $km.'compare.webp' ); ?>" alt="Το NORIKS FIT σε σύγκριση με συνηθισμένα φανελάκια" loading="lazy"></div>
      <div class="kmf-table">
        <div class="kmf-t-head">
          <span class="kmf-t-feature"></span>
          <span class="kmf-t-col kmf-t-us">NORIKS FIT</span>
          <span class="kmf-t-col kmf-t-them">Τα άλλα</span>
        </div>
        <?php
        $kmf_rows = array(
          'Άνετη συμπίεση όλη την ημέρα',
          'Ανθεκτικό υλικό υψηλής ποιότητας',
          'Αόρατο κάτω από οποιοδήποτε πουκάμισο',
          'Ταυτόχρονα και αθλητικό φανελάκι',
          'Ελαφρύ ύφασμα που απομακρύνει την υγρασία',
        );
    ...
    <div class="kmf-cta-wrap"><a class="kmf-cta" href="#bundle-selector">Παράγγειλε το NORIKS FIT σου →</a></div>
  </div>
</section>
...
<section class="kmf-sec">
  <div class="kmf-wrap">
    <div class="kmf-rev-top">
      ...
      <span class="kmf-rev-head">3.575 επαληθευμένες αξιολογήσεις — εξαιρετικό, 4,8 στα 5 αστέρια</span>
    </div>
    <div class="kmf-rev-cards">
      <div class="kmf-rev-card">
        <div class="kmf-rev-photo"><img src="<?php echo esc_url( $km.'wear.webp' ); ?>" alt="Αξιολόγηση πελάτη NORIKS FIT" loading="lazy"></div>
        <p class="kmf-rev-txt">«Θα είμαι ειλικρινής — ήμουν δύσπιστος. Πάντα είχα εκείνη την κοιλίτσα που έκρυβα κάτω από φαρδιές μπλούζες. Μετά από 4 εβδομάδες με το NORIKS 4 ώρες την ημέρα, έχασα μερικούς πόντους στη μέση και άρχισα να στέκομαι όρθια χωρίς να το σκέφτομαι. Οι ώμοι άνοιξαν, και η κοπέλα μου είπε ότι μοιάζω σαν να "λάμπω".»</p>
        <div class="kmf-rev-foot"><span class="kmf-rev-badge">★★★★★ Επαληθευμένος</span><span class="kmf-rev-name">Γιάννης Μ. — 34 ετών</span></div>
      </div>
      <div class="kmf-rev-card">
        <div class="kmf-rev-photo"><img src="<?php echo esc_url( $km.'persona.webp' ); ?>" alt="Αξιολόγηση πελάτη NORIKS FIT" loading="lazy"></div>
        <p class="kmf-rev-txt">«Όλη μέρα κάθομαι στο γραφείο. Καμπουριασμένος, φουσκωμένος, χωρίς αυτοπεποίθηση. Το NORIKS κυριολεκτικά με έβαλε να κάθομαι όρθια χωρίς καμία προσπάθεια. Σε 10 ημέρες η ένταση στην πλάτη εξαφανίστηκε και τα πουκάμισα άρχισαν να εφαρμόζουν καλύτερα. Τώρα το φοράω στο γραφείο — είναι διακριτικό, αναπνέει, και ειλικρινά; Σταμάτησα να κρύβομαι από τις κάμερες.»</p>
        <div class="kmf-rev-foot"><span class="kmf-rev-badge">★★★★★ Επαληθευμένος</span><span class="kmf-rev-name">Μάριος Π. — 42 ετών</span></div>
      </div>
      <div class="kmf-rev-card">
        <div class="kmf-rev-photo"><img src="<?php echo esc_url( $km.'hero.webp' ); ?>" alt="Αξιολόγηση πελάτη NORIKS FIT" loading="lazy"></div>
        <p class="kmf-rev-txt">«Τρία χρόνια απέφευγα τις εξόδους γιατί μισούσα αυτό που έβλεπα στον καθρέφτη όταν ντυνόμουν. Με το NORIKS, για πρώτη φορά σταμάτησα να πολεμάω με το είδωλό μου. Σήμερα το πρωί ντύθηκα σε 5 λεπτά. Χωρίς διορθώσεις. Χωρίς να αποφεύγω τον καθρέφτη. Αυτό ήταν.»</p>
        <div class="kmf-rev-foot"><span class="kmf-rev-badge">★★★★★ Επαληθευμένος</span><span class="kmf-rev-name">Θοδωρής Κ. — 27 ετών</span></div>
      </div>
    </div>
    <div class="kmf-cta-wrap"><a class="kmf-cta" href="#bundle-selector">Διάλεξε το μέγεθός σου →</a></div>
  </div>
</section>
