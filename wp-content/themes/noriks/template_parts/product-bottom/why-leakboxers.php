 ...
 * Ανδρικά εσώρουχα για ακράτεια — απορροφητικά μποξεράκια. (GR translation of HR original.)
...
<section class="lbx-sec lbx-reason">
  <div class="lbx-wrap lbx-row2">
    <div class="lbx-copy">
      <p class="lbx-eyebrow">Πάρτε πίσω την αξιοπρέπειά σας</p>
      <h2 class="lbx-h2">Οι προστασίες μίας χρήσης είναι <em>ταπεινωτικές</em></h2>
      <p>Σερβιέτες που ακούγονται, πάνες που φαίνονται κάτω από τα ρούχα και συνεχής φόβος διαρροής. Αξίζετε μια λύση που μοιάζει και νιώθει σαν κανονικό εσώρουχο.</p>
      <ul class="lbx-check">
        <li><strong>250 κιλά</strong> απορρίμματα τον χρόνο ανά χρήστη</li>
        <li>Περισσότερα από <strong>800 €</strong> πεταμένα κάθε χρόνο</li>
        <li>Τα προϊόντα μίας χρήσης είναι ογκώδη και γεμάτα χημικά</li>
      </ul>
      <a class="lbx-cta lbx-cta-solid" href="#bundle-selector">Θέλω πίσω την αυτοπεποίθησή μου →</a>
    </div>
    <div class="lbx-media"><img src="<?php echo esc_url( $lb.'boxer-navy.jpg' ); ?>" alt="NORIKS απορροφητικά μποξεράκια — σκούρο μπλε" loading="lazy"></div>
  </div>
</section>
...
<section class="lbx-sec lbx-alt">
  <div class="lbx-wrap">
    <h2 class="lbx-h2 lbx-center">Η αξιοπρέπεια που σας αξίζει</h2>
    <p class="lbx-sub lbx-center">Δείτε γιατί περισσότεροι από 123.000 άνδρες δεν επέστρεψαν ποτέ στις προστασίες μίας χρήσης.</p>
...
<section class="lbx-sec">
  <div class="lbx-wrap lbx-row2 lbx-rev">
    <div class="lbx-media"><img src="<?php echo esc_url( $lb.'features.png' ); ?>" alt="NORIKS PureDry — τεχνολογία απορρόφησης 7 στρωμάτων" loading="lazy"></div>
    <div class="lbx-copy">
      <p class="lbx-eyebrow">Τεχνολογία</p>
      <h2 class="lbx-h2">NORIKS <em>PureDry™</em> — 7 στρώματα προστασίας</h2>
      <p>Μετά από περισσότερα από 2 χρόνια ανάπτυξης δημιουργήσαμε ένα ύφασμα που απορροφά στιγμιαία και κλειδώνει την υγρασία βαθιά μέσα στον πυρήνα — χωρίς όγκο και χωρίς αίσθηση υγρασίας στο δέρμα.</p>
      <ul class="lbx-check">
        <li>Τεχνολογία απορρόφησης 7 στρωμάτων — έως <strong>300 ml</strong></li>
        <li>Αντιβακτηριδιακή ίνα μπαμπού</li>
        <li>Προστασία από διαρροές στα πόδια</li>
        <li>Έλεγχος οσμών και αδιάβροχο εξωτερικό στρώμα</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="lbx-sec lbx-video lbx-alt">
  <div class="lbx-wrap lbx-row2">
    <div class="lbx-copy">
      <p class="lbx-eyebrow">Η διαφορά NORIKS</p>
      <h2 class="lbx-h2">Δείτε πώς <em>εξαφανίζεται</em>. Μηδέν διαρροές.</h2>
      <p>Το εξωτερικό στρώμα είναι αδιάβροχο, ενώ ο απορροφητικός πυρήνας κρατά το υγρό μέσα. Αποτέλεσμα: μένετε στεγνοί — χωρίς λεκέδες και χωρίς αμηχανία, στη δουλειά, στο ταξίδι και στον ύπνο.</p>
      <div class="lbx-chips"><span>Χωρίς διαρροές</span><span>Χωρίς όγκο</span><span>Χωρίς οσμές</span></div>
    </div>
    <div class="lbx-media">
...
<section class="lbx-sec">
  <div class="lbx-wrap">
    <p class="lbx-eyebrow lbx-center">Θα τα αγαπήσετε</p>
    <h2 class="lbx-h2 lbx-center">Πλενόμενα <em>μποξεράκια ακράτειας</em></h2>
    <div class="lbx-cards">
      <figure class="lbx-card"><img src="<?php echo esc_url( $lb.'boxer-black.jpg' ); ?>" alt="Κομψή προστασία" loading="lazy"><figcaption>Κομψή προστασία</figcaption></figure>
      <figure class="lbx-card"><img src="<?php echo esc_url( $lb.'absorption.jpg' ); ?>" alt="Ασυναγώνιστη απορρόφηση" loading="lazy"><figcaption>Ασυναγώνιστη απορρόφηση</figcaption></figure>
      <figure class="lbx-card"><img src="<?php echo esc_url( $lb.'hydrofuge.jpg' ); ?>" alt="Υδρόφοβη τεχνολογία" loading="lazy"><figcaption>Υδρόφοβη τεχνολογία</figcaption></figure>
    </div>
  </div>
</section>
...
<section class="lbx-sec lbx-stats">
  <div class="lbx-wrap">
    <p class="lbx-eyebrow lbx-center lbx-eyebrow-d">Αποδεδειγμένο με δεδομένα</p>
    <h2 class="lbx-h2 lbx-center lbx-h2-d">Ακόμη δεν έχετε <em>πειστεί;</em></h2>
    <div class="lbx-rings">
      <?php
      $lbx_stats = array(
        array( 'p'=>'98', 'dash'=>'172.4', 't'=>'των ανδρών λένε ότι <strong>δεν θα επιστρέψουν ποτέ</strong> σε σερβιέτες ή πάνες' ),
        array( 'p'=>'95', 'dash'=>'167.1', 't'=>'αναφέρουν <strong>μηδενικό άγχος</strong> για διαρροές κατά τη διάρκεια της ημέρας' ),
        array( 'p'=>'97', 'dash'=>'170.6', 't'=>'νιώθουν <strong>αισθητά μεγαλύτερη αυτοπεποίθηση</strong>' ),
      );
...
<section class="lbx-sec">
  <div class="lbx-wrap-narrow">
    <h2 class="lbx-h2 lbx-center">Πιο έξυπνη επιλογή από τις <em>σερβιέτες μίας χρήσης</em></h2>
    <div class="lbx-cmp-scroll">
      <table class="lbx-cmp-table">
        <thead><tr><th></th><th class="lbx-us">NORIKS</th><th>Σερβιέτες μίας χρήσης</th><th>Απλά μποξεράκια</th></tr></thead>
        <tbody>
          <tr><td>Απορροφά έως 300 ml</td><td class="us ok">✓</td><td class="mid">εν μέρει</td><td class="no">✕</td></tr>
          <tr><td>Διακριτικό κάτω από τα ρούχα</td><td class="us ok">✓</td><td class="no">✕</td><td class="ok">✓</td></tr>
          <tr><td>Πλενόμενο και επαναχρησιμοποιήσιμο</td><td class="us ok">✓</td><td class="no">✕</td><td class="ok">✓</td></tr>
          <tr><td>Προστασία από οσμές</td><td class="us ok">✓</td><td class="mid">χημικά</td><td class="no">✕</td></tr>
          <tr><td>Ετήσιο κόστος</td><td class="us ok">✓ χαμηλό</td><td class="mid">800 €+</td><td class="ok">χαμηλό</td></tr>
          <tr><td>Οικολογικό</td><td class="us ok">✓</td><td class="no">✕ 250 κιλά απορρίμματα</td><td class="ok">✓</td></tr>
        </tbody>
      </table>
    </div>
    <div class="lbx-cta-wrap"><a class="lbx-cta lbx-cta-solid" href="#bundle-selector">Διάλεξε το πακέτο σου</a></div>
  </div>
</section>
...
<section class="lbx-sec lbx-alt">
  <div class="lbx-wrap">
    <p class="lbx-eyebrow lbx-center">Εμπειρίες πελατών</p>
    <h2 class="lbx-h2 lbx-center">Το εσώρουχο που ήδη εμπιστεύονται <em>123.000+ άνδρες</em></h2>
    ...
    <div class="lbx-cta-wrap"><a class="lbx-cta lbx-cta-solid" href="#bundle-selector">Παράγγειλε διακριτικά →</a></div>
  </div>
</section>
