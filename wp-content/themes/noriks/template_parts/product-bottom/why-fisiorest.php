...
// 1) "Επιστημονικά τεκμηριωμένο" — 4 κάρτες.
$fis_science = array(
    array( 'title' => 'Καμπούρα στον αυχένα',   'text' => 'Η έλξη <strong>απελευθερώνει την πίεση και επαναφέρει τη σωστή στάση</strong>, μειώνοντας την καμπούρα από τον «τεχνολογικό αυχένα».' ),
    array( 'title' => 'Πόνοι στον αυχένα',      'text' => '<strong>Χαλαρώνει τους μυϊκούς κόμβους και τη δυσκαμψία</strong> και <strong>επανευθυγραμμίζει την καμπύλη του αυχένα</strong> για γρήγορη ανακούφιση.' ),
    array( 'title' => 'Ποιοτικός ύπνος',         'text' => 'Η καταπραϋντική θεραπεία <strong>χαλαρώνει τον αυχένα και τη σπονδυλική στήλη</strong> για βαθύ και ξεκούραστο ύπνο.' ),
    array( 'title' => 'Απελευθέρωση στρες',      'text' => 'Το ζεστό μασάζ και οι διατάσεις <strong>απελευθερώνουν τη συσσωρευμένη ένταση</strong> για μεγαλύτερη άνεση.' ),
);
...
$fis_experts = array(
    array( 'img' => $fis_i.'fis-strucnjak-1.jpg', 'name' => 'Μαρίνα Παπαδοπούλου', 'role' => 'Πιστοποιημένη θεραπεύτρια μασάζ', 'org' => '' ),
    array( 'img' => $fis_i.'fis-strucnjak-2.jpg', 'name' => 'Άννα Δημητρίου', 'role' => 'Φυσικοθεραπεύτρια', 'org' => '' ),
    array( 'img' => $fis_i.'fis-strucnjak-3.jpg', 'name' => 'Ιωάννα Νικολάου', 'role' => 'Χειροπράκτρια', 'org' => '' ),
);
// 4) Εμπειρίες χρηστών
$fis_ugc = array(
    array( 'vid' => $fis_v.'v09c.mp4', 'cap' => '«Για πρώτη φορά μετά από καιρό είμαι επιτέλους χωρίς πόνο…»' ),
    array( 'vid' => $fis_v.'v06.mp4', 'cap' => '«Το μαξιλάρι NORIKS έγινε η νέα καθημερινή μου αναγκαιότητα…»' ),
    array( 'vid' => $fis_v.'v11c.mp4', 'cap' => '«Με βοηθάει πολύ να ανακουφίζω την ένταση στον αυχένα και τους ώμους.»' ),
    array( 'vid' => $fis_v.'v02c.mp4', 'cap' => '«Αν μόλις γίνατε μαμά, αυτό ίσως είναι ακριβώς αυτό που χρειάζεστε…»' ),
);
// 5) ThermoTrac 3-σε-1
$fis_thermo = array(
    array( 'vid' => $fis_v.'v10.mp4', 'title' => 'Θεραπεία με έλξη' ),
    array( 'vid' => $fis_v.'v07.mp4', 'title' => 'Θεραπεία με δόνηση' ),
    array( 'vid' => $fis_v.'v05.mp4', 'title' => 'Θεραπεία με θερμότητα' ),
);
// 6) Τέσσερις βελτιώσεις
$fis_upgrades = array(
    array( 't' => 'Επαναφορτιζόμενη μπαταρία', 'd' => 'Πάρτε το παντού — η μπαταρία 2500 mAh αντέχει έως 2 ώρες.' , 'ico' => 'battery-v2.png' ),
    array( 't' => 'Κάλυμμα από μεταξωτό', 'd' => 'Τυλιγμένο σε δροσερό μετάξι για απαλή, πολυτελή αίσθηση.' , 'ico' => 'silk-v2.png' ),
    array( 't' => 'Απενεργοποίηση στα 30 λεπτά', 'd' => 'Τέσσερις συνεδρίες των 30 λεπτών με μία φόρτιση, χωρίς ανησυχία.' , 'ico' => 'timer-v2.png' ),
    array( 't' => 'Ρυθμιζόμενη θερμότητα', 'd' => 'Θέρμανση στους 50 °C με την προηγμένη τεχνολογία ThermoTrac.' , 'ico' => 'heat-v2.png' ),
);
?>
...
<section class="fis-science">
  <div class="fis-wrap">
    <div class="fis-box">
      <h2 class="fis-title">Επιστημονικά τεκμηριωμένο: αποδεδειγμένη ανακούφιση για τη φροντίδα του αυχένα</h2>
      <div class="fis-grid">
...
<section class="fis-hero">
  ...
  <div class="fis-hero-inner">
    <h2 class="fis-hero-title">Ξεκλειδώστε βαθιά επανεκκίνηση με τη συνδυασμένη δύναμη ευθυγράμμισης και χαλάρωσης</h2>
  </div>
</section>
...
<section class="fis-experts">
  <div class="fis-wrap fis-exp-grid">
    <div class="fis-exp-quote">
      <h2 class="fis-h2">Το προτείνουν οι ειδικοί</h2>
      <p>«Το NORIKS είναι ένα από τα καλύτερα μαξιλάρια αυχένα που κυκλοφορούν αυτή τη στιγμή στην αγορά. Καθώς βρίσκομαι στην κοινότητα ευεξίας πάνω από 25 χρόνια, έχω δοκιμάσει διάφορα μαξιλάρια αυχένα, και αυτό που ξεχωρίζει το NORIKS είναι η λειτουργία έλξης…</p>
      <p>Αν έχετε προτεταμένο κεφάλι ή «κυρτή στάση», η έλξη μπορεί να βοηθήσει τους σπονδύλους να επανευθυγραμμιστούν και να στηρίξουν πλήρως το σώμα. Το χρησιμοποιώ και εγώ και το προτείνω στους πελάτες μου!»</p>
      <p class="fis-exp-author"><strong>Μαρίνα Παπαδοπούλου</strong><br>Πιστοποιημένη θεραπεύτρια μασάζ</p>
    </div>
...
<section class="fis-thermo">
  <div class="fis-wrap">
    <p class="fis-eyebrow"><strong>ThermoTrac™</strong> τεχνολογία</p>
    <h2 class="fis-h2 fis-center">Ζήστε τη θεραπεία αυχένα 3-σε-1</h2>
...
<section class="fis-upg">
  <div class="fis-wrap">
    <h2 class="fis-h2 fis-center">Τέσσερις μεγάλες βελτιώσεις</h2>
...
<section class="fis-cheaper">
  <div class="fis-wrap fis-row2">
    ...
    <div class="fis-row2-copy">
      <p class="fis-eyebrow">ΑΣΦΑΛΗΣ ΚΑΙ ΧΑΛΑΡΩΤΙΚΗ ΘΕΡΑΠΕΙΑ</p>
      <h2 class="fis-h2">14× φθηνότερο από εβδομαδιαία ραντεβού</h2>
      <p>Το NORIKS αποσβένεται σε μέρες, όχι σε μήνες. Προτείνεται από θεραπευτές, προσφέρει ήπια ανακούφιση χωρίς έντονη πίεση ή επικίνδυνες επεμβάσεις. Χρησιμοποιήστε το κάθε βράδυ. Χωρίς ραντεβού. Χωρίς μετακινήσεις. Χωρίς επαναλαμβανόμενα έξοδα — μόνο ασφαλής, σταθερή φροντίδα αυχένα, όποτε τη χρειάζεστε.</p>
    </div>
  </div>
</section>
