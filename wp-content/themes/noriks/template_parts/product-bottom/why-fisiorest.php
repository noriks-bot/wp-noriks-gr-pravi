...
$fis_experts = array(
    array( 'vid' => $fis_v.'v01.mp4', 'name' => 'Μαρίνα Παπαδοπούλου', 'role' => 'Πιστοποιημένη θεραπεύτρια μασάζ', 'org' => '' ),
    array( 'vid' => $fis_v.'v08.mp4', 'name' => 'Δρ. Άννα Δημητρίου',  'role' => 'Διδάκτωρ φυσικοθεραπείας',        'org' => '' ),
    array( 'vid' => $fis_v.'v03.mp4', 'name' => 'Δρ. Γιάννης Νικολάου','role' => 'Διδάκτωρ χειροπρακτικής',         'org' => '' ),
);
// 4) Εμπειρίες χρηστών
$fis_ugc = array(
