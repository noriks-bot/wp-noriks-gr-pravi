  ...
  <div class="bun-wrap bun-row">
    <div class="bun-col bun-copy">
      ...
      <ul class="bun-reasons">
        ...
        <li><strong>Εγγύηση επιστροφής χρημάτων 30 ημερών</strong> («αποτελέσματα ή πλήρης επιστροφή»), γιατί είμαστε τόσο σίγουροι για το προϊόν μας και ξέρουμε ότι θα σας βοηθήσει</li>
      </ul>
    </div>
    <div class="bun-col bun-media">
