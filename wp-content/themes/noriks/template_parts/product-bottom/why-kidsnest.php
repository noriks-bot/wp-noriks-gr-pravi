...
<div class="kn-marquee" aria-hidden="true">
  <div class="kn-marquee-track">
    <?php $kn_ticker = array('ΣΥΣΤΗΝΕΤΑΙ ΑΠΟ ΠΑΙΔΙΑΤΡΟΥΣ','ΑΦΡΟΣ ΜΝΗΜΗΣ OEKO-TEX®','ΔΟΜΗ 3 ΖΩΝΩΝ','90 ΝΥΧΤΕΣ ΔΟΚΙΜΗΣ','ΥΠΟΑΛΛΕΡΓΙΚΟ','ΔΙΑΠΝΕΟΥΣΑ ΠΛΕΞΗ');
...
<section class="kn-sec">
  <div class="kn-wrap kn-row2">
    ...
    <div class="kn-copy">
      ...
      <p>Η πλέξη είναι διαπνέουσα και ο αφρός είναι <strong>υποαλλεργικός και ανθεκτικός στα ακάρεα</strong> — έτσι το μαξιλάρι μένει φρέσκο, καθαρό και έτοιμο για κάθε νύχτα. Χωρίς βαθουλώματα, χωρίς να «κάθεται», χωρίς συμβιβασμούς.</p>
