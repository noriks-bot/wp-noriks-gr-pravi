...
<section class="oj-sec oj-alt">
  <div class="oj-wrap oj-row2">
    <div class="oj-media"><?php echo $oj_img('erg-gr-04.webp','Σύσταση γιατρού — NORIKS ErgoSit'); ?></div>
    <div class="oj-copy">
...
<section class="oj-sec oj-guar-sec">
  ...
  <div class="oj-guarantee oj-row2">
    <div class="oj-guar-badge"><?php echo $oj_img('15_znacka_30_dana.png','Εγγύηση επιστροφής χρημάτων 30 ημερών'); ?></div>
    <div class="oj-guar-copy">
      <h2 class="oj-h2 oj-h2-light">Δοκιμάστε το <em class="oj-pink-i">60 ημέρες</em>, χωρίς άγχος</h2>
      <p>Το να βρείτε το σωστό μαξιλάρι δεν είναι εύκολο — πολλά ξεφουσκώνουν ή απλώς δεν φέρνουν πραγματική ανακούφιση. Γι' αυτό κάθε NORIKS <strong>ErgoSit</strong> συνοδεύεται από την <strong>εγγύηση άνεσης 30 ημερών</strong>.</p>
