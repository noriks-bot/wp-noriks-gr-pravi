...
<section class="nrd-intro">
  <div class="nrd-wrap">
    <div class="nrd-intro__top">
      <div class="nrd-intro__img"><?php echo $rd_img( 'red-meet.jpg', 'Περικάρπιο NORIKS RedRelief με κόκκινο φως' ); ?></div>
      <div class="nrd-intro__text">
        <p class="nrd-kicker">Γνωρίστε το NORIKS RedRelief</p>
        <h2 class="nrd-h2">Βοήθεια που στοχεύει την αιτία, όχι μόνο το σύμπτωμα.</h2>
        <p>Το NORIKS RedRelief φέρνει κόκκινο και υπέρυθρο φως διπλού μήκους κύματος ακριβώς στην περιοχή του μέσου νεύρου — εκεί όπου δημιουργείται η φλεγμονή πίσω από τον πόνο στον καρπό.</p>
        <p>Η ίδια θεραπεία με κόκκινο φως έχει μελετηθεί για την ενίσχυση της παραγωγής κυτταρικής ενέργειας (ATP), την αποκατάσταση της ροής του αίματος και την παροχή οξυγόνου στον ιστό — ώστε το σώμα να μπορεί να κάνει τη δουλειά του.</p>
      </div>
    </div>

    <div class="nrd-stats">
      <div class="nrd-stat"><div class="nrd-stat__big">87%</div><div class="nrd-stat__lab">Λιγότερο μυρμήγκιασμα και μούδιασμα</div><div class="nrd-stat__sub">Μέσα στις πρώτες 30 ημέρες*</div></div>
      <div class="nrd-stat"><div class="nrd-stat__big">92%</div><div class="nrd-stat__lab">Καλύτερος ύπνος όλη τη νύχτα</div><div class="nrd-stat__sub">Μετά από 4+ εβδομάδες καθημερινής χρήσης*</div></div>
      <div class="nrd-stat"><div class="nrd-stat__big">94%</div><div class="nrd-stat__lab">Θα σύστηναν το NORIKS RedRelief</div><div class="nrd-stat__sub">Σε φίλους και οικογένεια*</div></div>
      <div class="nrd-stat"><div class="nrd-stat__big">71%</div><div class="nrd-stat__lab">Ανέβαλαν ή απέφυγαν την επέμβαση</div><div class="nrd-stat__sub">Λόγω συνδρόμου καρπιαίου σωλήνα*</div></div>
    </div>
    <p class="nrd-foot">*Με βάση τις εμπειρίες πελατών που χρησιμοποιούν τακτικά το NORIKS RedRelief. Τα αποτελέσματα διαφέρουν από άτομο σε άτομο.</p>
  </div>
</section>
...
<section class="nrd-steps">
  <div class="nrd-wrap">
    <p class="nrd-kicker nrd-center">Πιο απλό δεν γίνεται</p>
    <h2 class="nrd-h2 nrd-center">Τρία βήματα ως τη συνεδρία</h2>
    <p class="nrd-sub">Χωρίς ραντεβού και χωρίς ρυθμίσεις. Απλώς το φοράτε, πατάτε και χαλαρώνετε.</p>
    <div class="nrd-steps__grid">
      <div class="nrd-steps__step">
        <div class="nrd-steps__media"><span class="nrd-steps__num">1</span><?php echo $rd_vid( 'red-vid-1.mp4', 'red-vid-1.jpg', 'Τοποθέτηση του περικαρπίου στον καρπό' ); ?></div>
        <h4>Φορέστε το περικάρπιο</h4>
        <p>Περάστε τον αντίχειρα από το άνοιγμα και στερεώστε το λουράκι πάνω από την πλάτη της παλάμης.</p>
      </div>
      <div class="nrd-steps__step">
        <div class="nrd-steps__media"><span class="nrd-steps__num">2</span><?php echo $rd_vid( 'red-vid-2.mp4', 'red-vid-2.jpg', 'Έναρξη συνεδρίας με ένα κουμπί' ); ?></div>
        <h4>Πατήστε το κουμπί</h4>
        <p>Ένα πάτημα ξεκινά μια συνεδρία 15 λεπτών. Επιλέξτε επίπεδο ισχύος και λειτουργία.</p>
      </div>
      <div class="nrd-steps__step">
        <div class="nrd-steps__media"><span class="nrd-steps__num">3</span><?php echo $rd_vid( 'red-vid-3.mp4', 'red-vid-3.jpg', 'Χαλάρωση κατά τη θεραπεία' ); ?></div>
        <h4>Χαλαρώστε</h4>
        <p>Αφήστε το φως να δουλέψει. Μία φορά την ημέρα — η σταθερότητα φέρνει το αποτέλεσμα.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="nrd-why">
  ...
  <div class="nrd-why__row nrd-why__row--reverse">
    <div class="nrd-why__imgwrap"><?php echo $rd_img( 'red-valne.jpg', 'Το εσωτερικό του περικαρπίου με αναμμένα κόκκινα LED', 'nrd-why__img' ); ?></div>
    <div class="nrd-why__content">
      <h2 class="nrd-h2">Δύο μήκη κύματος. Διπλή εμβέλεια.</h2>
      <p class="nrd-why__body">Το NORIKS RedRelief συνδυάζει τα δύο πιο μελετημένα μήκη κύματος στη θεραπεία με κόκκινο φως, οπότε μία συνεδρία καλύπτει και την επιφάνεια και το βάθος.</p>
      <ul class="nrd-checks">
        <li><span class="nrd-ck"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7.5"/></svg></span><span><strong>Κόκκινο φως 660 nm</strong> — καταπραΰνει την επιφανειακή φλεγμονή</span></li>
        <li><span class="nrd-ck"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7.5"/></svg></span><span><strong>Υπέρυθρο 850 nm</strong> — φτάνει στο μέσο νεύρο</span></li>
      </ul>
    </div>
  </div>

  <div class="nrd-why__row">
    <div class="nrd-why__imgwrap"><?php echo $rd_img( 'red-led.jpg', '48 διπλά LED στο περικάρπιο', 'nrd-why__img' ); ?></div>
    <div class="nrd-why__content">
      <h2 class="nrd-h2">48 διπλά LED.</h2>
      <p class="nrd-why__body">Τα LED είναι κατανεμημένα σε όλη την εσωτερική πλευρά της ελαφριάς ταινίας που ακολουθεί το σχήμα του καρπού — έτσι κάθε συνεδρία καλύπτει όλη την περιοχή, όχι μόνο ένα σημείο.</p>
      <ul class="nrd-checks">
        <li><span class="nrd-ck"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7.5"/></svg></span><span><strong>48 LED</strong> (κόκκινα + υπέρυθρα)</span></li>
        <li><span class="nrd-ck"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7.5"/></svg></span><span><strong>3 επίπεδα ισχύος</strong> · 4 λειτουργίες</span></li>
        <li><span class="nrd-ck"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7.5"/></svg></span><span><strong>Μόλις 126 g</strong> — αρκετά ελαφρύ για κάθε μέρα</span></li>
      </ul>
    </div>
  </div>
...
<section class="nrd-pain">
  <div class="nrd-wrap nrd-pain__wrap">
    <div class="nrd-pain__text">
      <p class="nrd-kicker">Για ποιους είναι το NORIKS RedRelief</p>
      <h2 class="nrd-h2">Για χέρια που δουλεύουν όλη μέρα.</h2>
      <p class="nrd-pain__body">Ο πόνος στον καρπό σπάνια έρχεται μόνος. Το NORIKS RedRelief απευθύνεται σε όσους καταπονούν καθημερινά το χέρι και τον καρπό — στο πληκτρολόγιο, στο τιμόνι, στο κομμωτήριο, στο εργοτάξιο ή στον κήπο.</p>
      <ul class="nrd-pills">
        <li>Σύνδρομο καρπιαίου σωλήνα</li><li>Τενοντίτιδα</li><li>Αρθρίτιδα</li><li>Πόνοι στο χέρι και στον καρπό</li>
      </ul>
      <p class="nrd-pain__note">Η συσκευή δεν αντικαθιστά την ιατρική εξέταση ούτε τη συνταγογραφούμενη θεραπεία.</p>
    </div>
    <div class="nrd-pain__img"><?php echo $rd_img( 'red-bolovi.jpg', 'Θεραπεία με κόκκινο φως στον καρπό' ); ?></div>
  </div>
</section>
...
<section class="nrd-tl">
  <div class="nrd-wrap">
  <h2 class="nrd-h2 nrd-center">Τι μπορείτε να περιμένετε</h2>
  <p class="nrd-sub">Τα αποτελέσματα θέλουν χρόνο. Αυτή είναι η πορεία που ακολουθούν οι περισσότεροι χρήστες.</p>
  ...
  <div class="nrd-tl__wrap">
    ...
    <div class="nrd-tl__step nrd-tl__step--right">
      ...
      <div class="nrd-tl__content">
        <div class="nrd-tl__eyebrow">Εβδομάδα 1</div>
        <h3 class="nrd-tl__name">Τα πρώτα σημάδια ανακούφισης</h3>
        <ul><li>Η φλεγμονή γύρω από το μέσο νεύρο αρχίζει να υποχωρεί</li><li>Ο καρπός δείχνει πιο ελαφρύς και ανακουφισμένος</li><li>Λιγότερη πρωινή δυσκαμψία</li><li>Πιο εύκολο κράτημα της κούπας ή του τιμονιού</li></ul>
      </div>
    </div>
    ...
    <div class="nrd-tl__step nrd-tl__step--left">
      <div class="nrd-tl__node"><svg viewBox="0 0 24 24" fill="none"><path d="M5 12.5l4.5 4.5L19 7.5" stroke="#fff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
      <div class="nrd-tl__content">
        <div class="nrd-tl__eyebrow">Εβδομάδα 2 – 3</div>
        <h3 class="nrd-tl__name">Ο πόνος της ημέρας υποχωρεί</h3>
        <ul><li>Το μυρμήγκιασμα και το μούδιασμα μειώνονται αισθητά</li><li>Η δύναμη λαβής βελτιώνεται</li><li>Η πληκτρολόγηση και το άνοιγμα βάζων γίνονται πιο εύκολα</li><li>Λιγότερα παυσίπονα</li></ul>
      </div>
    </div>
    ...
    <div class="nrd-tl__step nrd-tl__step--right">
      <div class="nrd-tl__node"><svg viewBox="0 0 24 24" fill="none"><path d="M5 12.5l4.5 4.5L19 7.5" stroke="#fff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
      <div class="nrd-tl__content">
        <div class="nrd-tl__eyebrow">Εβδομάδα 4 – 6</div>
        <h3 class="nrd-tl__name">Ύπνος όλη τη νύχτα</h3>
        <ul><li>Τα μουδιασμένα χέρια δεν σας ξυπνούν πια</li><li>Ξύπνημα χωρίς δυσκαμψία στα δάχτυλα</li><li>Επιστροφή στα χόμπι — κιθάρα, πλέξιμο, κήπος</li><li>Επιστρέφει η εμπιστοσύνη στα ίδια σας τα χέρια</li></ul>
      </div>
    </div>
    ...
    <div class="nrd-tl__step nrd-tl__step--left">
      <div class="nrd-tl__node"><svg viewBox="0 0 24 24" fill="none"><path d="M5 12.5l4.5 4.5L19 7.5" stroke="#fff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
      <div class="nrd-tl__content">
        <div class="nrd-tl__eyebrow">Εβδομάδα 8+</div>
        <h3 class="nrd-tl__name">Μακροπρόθεσμη υγεία του χεριού</h3>
        <ul><li>Η λειτουργία του καρπού συνεχίζει να βελτιώνεται</li><li>Ο πόνος γίνεται ανάμνηση, όχι καθημερινότητα</li><li>Θεραπεία χωρίς χάπια και χωρίς επέμβαση</li><li>Η συνεδρία των 15 λεπτών μένει μέρος της ημέρας</li></ul>
      </div>
    </div>
  </div>
  </div>
...
<section class="nrd-vs">
  <div class="nrd-wrap nrd-vs__inner">
    ...
    <h2 class="nrd-vs__title-mobile">Γιατί NORIKS RedRelief<sup>&reg;</sup>?</h2>
    ...
    <div class="nrd-vs__cards">
      ...
      <div class="nrd-vs__card nrd-vs__card--us">
        ...
        <div class="nrd-vs__list">
          <div class="nrd-vs__row"><span class="nrd-vs__ic nrd-vs__ic--yes">&#10003;</span>Διπλό μήκος κύματος</div>
          <div class="nrd-vs__row"><span class="nrd-vs__ic nrd-vs__ic--yes">&#10003;</span>48 διπλά LED</div>
          <div class="nrd-vs__row"><span class="nrd-vs__ic nrd-vs__ic--yes">&#10003;</span>3 επίπεδα ισχύος, 4 λειτουργίες</div>
          <div class="nrd-vs__row"><span class="nrd-vs__ic nrd-vs__ic--yes">&#10003;</span>Ασύρματο και επαναφορτιζόμενο</div>
          <div class="nrd-vs__row"><span class="nrd-vs__ic nrd-vs__ic--yes">&#10003;</span>Σχεδιασμένο για το χέρι</div>
        </div>
      </div>

      <div class="nrd-vs__card nrd-vs__card--them">
        <div class="nrd-vs__card-title nrd-vs__card-title--dark">Άλλες συσκευές</div>
        <div class="nrd-vs__list">
          <div class="nrd-vs__row nrd-vs__row--dark"><span class="nrd-vs__ic nrd-vs__ic--no">&#10007;</span>Μόνο ένα μήκος κύματος</div>
          <div class="nrd-vs__row nrd-vs__row--dark"><span class="nrd-vs__ic nrd-vs__ic--no">&#10007;</span>Λιγότερα LED και κάλυψη</div>
          <div class="nrd-vs__row nrd-vs__row--dark"><span class="nrd-vs__ic nrd-vs__ic--no">&#10007;</span>Σταθερή ένταση</div>
          <div class="nrd-vs__row nrd-vs__row--dark"><span class="nrd-vs__ic nrd-vs__ic--no">&#10007;</span>Εξαρτώνται από πρίζα</div>
          <div class="nrd-vs__row nrd-vs__row--dark"><span class="nrd-vs__ic nrd-vs__ic--no">&#10007;</span>Ενιαίο σχέδιο</div>
        </div>
      </div>
    ...
    <div class="nrd-vs__copy">
      <h2 class="nrd-vs__title">Γιατί NORIKS RedRelief<sup>&reg;</sup>?</h2>
      <div class="nrd-vs__bullets">
        <div class="nrd-vs__bullet"><span class="nrd-vs__bc">&#10003;</span><span>Σχεδιασμένο ακριβώς για το χέρι και τον καρπό</span></div>
        <div class="nrd-vs__bullet"><span class="nrd-vs__bc">&#10003;</span><span>Διπλό μήκος κύματος σε μία συνεδρία</span></div>
        <div class="nrd-vs__bullet"><span class="nrd-vs__bc">&#10003;</span><span>Ασύρματα, οπουδήποτε, 15 λεπτά την ημέρα</span></div>
        <div class="nrd-vs__bullet"><span class="nrd-vs__bc">&#10003;</span><span>Έως 4 θεραπείες με μία φόρτιση</span></div>
      </div>
      <a class="nrd-vs__cta" href="#bundle-selector">Δοκιμάστε χωρίς ρίσκο</a>
      <div class="nrd-vs__guar"><span class="nrd-vs__shield">&#128737;</span> 30 ημέρες επιστροφή χρημάτων</div>
    </div>
