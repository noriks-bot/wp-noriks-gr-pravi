...
<section class="why-section knc-demo">
  <div class="knc-demo-wrap">
    <h2 class="knc-demo-title">Πώς λειτουργεί στην πράξη</h2>
...
<section class="why-section knc-compare-section">
  <div class="knc-compare-wrap">
    <h2 class="knc-compare-title">NORIKS vs οι υπόλοιποι</h2>
    <div class="knc-table-scroll">
      <table class="knc-table">
        <thead>
          <tr>
            <th class="knc-feat"></th>
            <th class="knc-comp">Κλασικές κάλτσες<span>(Bauerfeind, medi…)</span></th>
            <th class="knc-comp">Κάλτσες TV<span>(Zip Sox &amp; Co.)</span></th>
            <th class="knc-us">NORIKS<em class="knc-badge">Νο. 1</em></th>
          </tr>
        </thead>
        <tbody>
          <tr><td>Ιατρική συμπίεση</td><td class="ok">✓</td><td class="no">✕</td><td class="us ok">✓</td></tr>
          <tr><td>Φερμουάρ για εύκολο φόρεμα</td><td class="no">✕</td><td class="ok">✓</td><td class="us ok">✓</td></tr>
          <tr><td>Αυτόνομο φόρεμα χωρίς βοήθεια</td><td class="no">✕</td><td class="mid">~</td><td class="us ok">✓</td></tr>
  ...
  <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
        <?php if ( $kn_img_1 ) : ?>
          <img loading="lazy" decoding="async" style="width:100%; aspect-ratio:1/1; object-fit:cover;" src="<?php echo esc_url( $kn_img_1 ); ?>" alt="Κάλτσες συμπίεσης">
    ...
    <div class="why-col why-content">
      <h2 style="color: #222; text-align:left; margin-left: 20px; font-family: 'Barlow', sans-serif; color:#222223;">
        ΓΙΑΤΙ ΚΑΛΤΣΕΣ ΣΥΜΠΙΕΣΗΣ;
      </h2>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Καλύτερη κυκλοφορία, λιγότερη κούραση</strong></p>
        <p class="description">Η διαβαθμισμένη συμπίεση διεγείρει απαλά τη ροή του αίματος προς την καρδιά, μειώνει την αίσθηση βάρους και κούρασης στα πόδια και βοηθά τα πόδια να παραμένουν ελαφριά ακόμη και στην πιο μεγάλη μέρα.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Λιγότερο πρήξιμο</strong></p>
        <p class="description">Ιδανικές για μεγάλα ταξίδια, πολλή ορθοστασία ή καθιστή εργασία. Η ομοιόμορφη πίεση μειώνει την κατακράτηση υγρών και το πρήξιμο στους αστραγάλους και τις γάμπες.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Υποστήριξη που τη νιώθεις</strong></p>
        <p class="description">Η ανατομική κοπή κρατά την κάλτσα στη θέση της, χωρίς σφίξιμο στο επάνω μέρος. Μια αίσθηση σταθερής αλλά άνετης υποστήριξης όλη τη μέρα.</p>
      </div>
    </div>
...
<section class="why-section knc-ugc">
  <div class="knc-ugc-wrap">
    <h2 class="knc-ugc-title">Τι λένε οι πελάτες μας</h2>
