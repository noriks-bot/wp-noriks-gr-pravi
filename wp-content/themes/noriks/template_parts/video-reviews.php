...
<section class="new-video-rewies">
  ...
  <div class="new-video-rewies__slider">
    ...
    <div class="new-video-rewies__card">
      <div class="new-video-rewies__video-box">
        <video preload="metadata" playsinline disablepictureinpicture
          poster="https://noriks.com/gr/wp-content/uploads/2025/12/ugc1.png">
          <source src="https://noriks.com/gr/wp-content/uploads/2025/12/ugc_1.mp4" type="video/mp4">
        </video>
        <span class="new-video-rewies__play-btn"></span>
      </div>
      <div class="new-video-rewies__content">
        <div class="new-video-rewies__header">
          <!--<img class="new-video-rewies__avatar" src="https://noriks.com/gr/wp-content/uploads/2025/12/dario_profilna.jpg">-->
          <div>
    ...
    <div class="new-video-rewies__card">
      <div class="new-video-rewies__video-box">
        <video preload="metadata" playsinline disablepictureinpicture
          poster="https://noriks.com/gr/wp-content/uploads/2025/12/ugc2.png">
          <source src="https://noriks.com/gr/wp-content/uploads/2025/12/ugc_2.mp4" type="video/mp4">
        </video>
        <span class="new-video-rewies__play-btn"></span>
      </div>
      <div class="new-video-rewies__content">
    ...
    <div class="new-video-rewies__card">
      <div class="new-video-rewies__video-box">
        <video preload="metadata" playsinline disablepictureinpicture
          poster="https://noriks.com/gr/wp-content/uploads/2025/12/ugc3.png">
          <source src="https://noriks.com/gr/wp-content/uploads/2025/12/ugc_3.mp4" type="video/mp4">
        </video>
        <span class="new-video-rewies__play-btn"></span>
      </div>
      <div class="new-video-rewies__content">
    ...
    <div class="new-video-rewies__card">
      <div class="new-video-rewies__video-box">
        <video preload="metadata" playsinline disablepictureinpicture
          poster="https://noriks.com/gr/wp-content/uploads/2025/12/ugc4.png">
          <source src="https://noriks.com/gr/wp-content/uploads/2025/12/ugc_4.mp4" type="video/mp4">
        </video>
        <span class="new-video-rewies__play-btn"></span>
      </div>
      <div class="new-video-rewies__content">
    ...
    <div class="new-video-rewies__card">
      <div class="new-video-rewies__video-box">
        <video preload="metadata" playsinline disablepictureinpicture
          poster="https://noriks.com/gr/wp-content/uploads/2025/12/ugc5.png">
          <source src="https://noriks.com/gr/wp-content/uploads/2025/12/ugc_5.mp4" type="video/mp4">
        </video>
        <span class="new-video-rewies__play-btn"></span>
      </div>
      <div class="new-video-rewies__content">
  ...
  <button class="new-video-rewies__nav new-video-rewies__prev">❮</button>
  <button class="new-video-rewies__nav new-video-rewies__next">❯</button>
</section>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  -------------------- */
  function isDesktop() {
    // if more than 1 card fits → desktop
...
videoBoxes.forEach(box => {
  ...
  video.addEventListener('click', () => {
    if (video.paused) {
      video.loop = true;        // ✅ ENSURE LOOP ON RESUME
      video.play();
      playBtn.style.display = 'none';
    } else {
      video.pause();
  ...
  slider.addEventListener('scroll', () => {
    if (isDesktop()) return; // ⛔ STOP DOT CHANGES ON DESKTOP
