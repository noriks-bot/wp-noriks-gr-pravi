...
$kompmajice_faq = array(
  ...
  array( 'questioon' => 'Πόσο γρήγορα θα δω αποτελέσματα;', 'answer' => 'Κάθε σώμα είναι διαφορετικό, αλλά οι περισσότεροι πελάτες αναφέρουν ορατή αλλαγή μέσα στις πρώτες 14 ημέρες. Για το καλύτερο αποτέλεσμα, φοράτε το NORIKS FIT καθημερινά και συνδυάστε το με ισορροπημένη διατροφή και τακτική κίνηση.' ),
...
$ortopas_faq = array(
  ...
  array( 'questioon' => 'Υπάρχει εγγύηση επιστροφής χρημάτων;', 'answer' => 'Προσφέρουμε εγγύηση ικανοποίησης! Αν δεν είστε ικανοποιημένοι με τη ζώνη NORIKS, επικοινωνήστε μαζί μας στο info@noriks.com για επιστροφή και αποζημίωση εντός 14 ημερών. Η προθεσμία μετρά από την παραλαβή της ζώνης.' ),
);
...
$fisiorest_faq = array(
  ...
  array( 'questioon' => 'Μπορώ να το επιστρέψω αν δεν δω αποτελέσματα;', 'answer' => 'Φυσικά! Προσφέρουμε πλήρη εγγύηση επιστροφής χρημάτων εντός 14 ημερών από την παράδοση, αν δεν είστε ικανοποιημένοι με το προϊόν. Γράψτε μας στο info@noriks.com και θα απαντήσουμε εντός 12 ωρών από την παραλαβή του μηνύματος!' ),
);
...
$norikshers_faq = array(
  ...
  array( 'questioon' => 'Υπάρχει εγγύηση επιστροφής χρημάτων;', 'answer' => 'Ναι, προσφέρουμε εγγύηση επιστροφής χρημάτων 14 ημερών χωρίς ρίσκο. Αν δεν είστε ικανοποιημένοι, απλώς επικοινωνήστε μαζί μας και θα το τακτοποιήσουμε.' ),
);
