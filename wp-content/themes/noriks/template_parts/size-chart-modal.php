...
<div id="custom-size-chart-modal" aria-modal="true" role="dialog" aria-labelledby="custom-size-chart-title">
  <div class="size-chart-titlebar">
    <h2 id="custom-size-chart-title">Πίνακας μεγεθών</h2>
  ...
  <div  style="<?php if ( has_term( array( 'orto-starter', 'orto-majica-bokserica' ), 'product_cat', get_the_ID() ) ): ?>  display: block; <?php endif; ?>"
      ...
      <div class="noriks-bx">
        ...
        <div class="noriks-bx-wrap">
          <table class="noriks-bx-t">
            <thead>
              <tr><th>Μέγεθος</th><th>S</th><th>M</th><th>L</th><th>XL</th><th>2XL</th><th>3XL</th><th>4XL</th></tr>
            </thead>
            <tbody>
        ...
        <img class="noriks-bx-fig" src="<?php echo esc_url( get_template_directory_uri() . '/img/boxers-measure.webp' ); ?>"
             alt="Διαστάσεις μπόξερ: a, b, c, d" loading="lazy">
        <p class="noriks-bx-note"><strong>Επιλέξτε το ίδιο νούμερο που φοράτε συνήθως.</strong><br>Οι διαστάσεις είναι σε εκατοστά. Τα μεγέθη μπορεί να διαφέρουν &plusmn;1&ndash;2 εκ. Αν είστε ανάμεσα σε δύο μεγέθη, επιλέξτε το μικρότερο &mdash; το ύφασμα είναι ελαστικό.</p>
      </div>
    ...
    style="margin-top: 35px;margin-bottom: 0px;"
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <p style="margin:0 0 4px;font-weight:700;font-size:15px;">Πώς να μετρήσετε τους γοφούς</p>
        <p style="margin:0 0 14px;line-height:1.6;font-size:14px;color:#333;">Τυλίξτε τη μεζούρα γύρω από το φαρδύτερο σημείο των γοφών (πάνω από τους γλουτούς), χωρίς να σφίγγετε, και σημειώστε τη μέτρηση σε εκατοστά.</p>
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          <thead><tr style="background:#12233b;color:#fff;">
            <th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Μέγεθος</th><th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Γοφοί (cm)</th>
          </tr></thead>
          <tbody>
          <?php foreach ( array(array('S','έως 76 cm','έως 30"'),array('M','77 – 85 cm','30 – 33"'),array('L','86 – 94 cm','34 – 37"'),array('XL','95 – 102 cm','37 – 40"'),array('2XL','103 – 114 cm','41 – 45"'),array('3XL','115 – 121 cm','45 – 48"'),array('4XL','122 – 129 cm','48 – 51"'),array('5XL','130 – 137 cm','51 – 54"'),array('6XL','138 – 145 cm','54 – 57"'),array('7XL','146 – 153 cm','57 – 60"'),array('8XL','154 cm και άνω','61" και άνω') ) as $i=>$r): ?>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;"><strong>Ανάμεσα σε δύο μεγέθη;</strong> Συνιστούμε το μεγαλύτερο για βέλτιστη άνεση και μέγιστη απορρόφηση.</p>
      </div>
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <table style="width:100%;border-collapse:collapse;font-size:16px;">
          <thead><tr style="background:#111;color:#fff;">
            <th style="padding:11px 12px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Μέγεθος</th><th style="padding:11px 12px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Αντίστοιχο βάρος</th>
          </tr></thead>
          <tbody>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;">Επιλέξτε μέγεθος με βάση το βάρος σας. Ανάμεσα σε δύο μεγέθη; Για ισχυρότερη συμπίεση επιλέξτε το μικρότερο.</p>
      </div>
      ...
      <div class="noriks-size-chart-wrap">
          ...
          <table class="noriks-sc">
            <thead>
              <tr>
                ...
                <th class="noriks-sc-empty" style="width:80px;">Μέγεθος</th>
                <th>59-68 kg</th>
                <th>69-77 kg</th>
                <th>78-84 kg</th>
                <th>84-95 kg</th>
            ...
            <tbody>
              <tr>
                <th class="noriks-sc-vis-label" rowspan="11">Ύψος (cm)</th>
                <th>168 cm</th>
        ...
        <div class="noriks-sc-steps">
          <h3>Πώς να βρεις το μέγεθός σου</h3>
          <div class="noriks-sc-steps-grid">
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">1</span>
              <span>Βρες το <strong>ύψος</strong> σου στην αριστερή στήλη.</span>
            </div>
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">2</span>
              <span>Βρες το <strong>βάρος</strong> σου στην επάνω γραμμή.</span>
            </div>
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">3</span>
              <span>Το πεδίο όπου τέμνονται &mdash; αυτό είναι το μέγεθός σου.</span>
            </div>
          </div>
        </div>
        ...
        <div class="noriks-sc-pro">
          ...
          <span>Αν είσαι ανάμεσα σε δύο μεγέθη και θέλεις πιο <strong>χαλαρή εφαρμογή</strong>, πάρε το μεγαλύτερο. Για πιο <strong>εφαρμοστή εμφάνιση</strong> πάρε το μικρότερο.</span>
        </div>

        <div class="noriks-sc-guarantee">
          <span class="noriks-sc-check">&#10003;</span>
          <span>Δεν είσαι σίγουρος; Δωρεάν αλλαγή μεγέθους εντός 30 ημερών.</span>
        </div>
      </div>
