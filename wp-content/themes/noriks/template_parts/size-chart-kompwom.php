<?php
/**
 * Tablica velicina za NORIKS FIT Woman (orto-kompwom) — trg GR.
...
<div id="custom-size-chart-modal" class="kwsc" role="dialog" aria-modal="true" aria-labelledby="kwsc-title">
  <div class="kwsc-box">
  <div class="kwsc-bar">
    <h2 id="kwsc-title">Πίνακας μεγεθών</h2>
    <span id="close-size-chart-x" role="button" tabindex="0" aria-label="Κλείσιμο">&times;</span>
  </div>

  <div class="kwsc-body">
    <p class="kwsc-lead">Διαλέξτε μέγεθος με βάση την <strong>περίμετρο στήθους</strong> — αυτή καθορίζει πώς κάθεται η μπλούζα στο στήθος και στους ώμους. Αν είστε ανάμεσα σε δύο μεγέθη, πάρτε το <strong>μεγαλύτερο</strong>.</p>


    <div class="kwsc-scroll">
      <table class="kwsc-table">
        <thead>
          <tr><th scope="col">Μέγεθος</th><th scope="col">Περίμετρος στήθους</th><th scope="col">Περίμετρος μέσης</th></tr>
        </thead>
        <tbody>
    ...
    <div class="kwsc-how">
      <h3>Πώς να μετρήσετε</h3>
      <ol>
        <li><strong>Στήθος</strong> — στο πιο φαρδύ σημείο του στήθους, με τη μεζούρα οριζόντια γύρω από το σώμα.</li>
        <li><strong>Μέση</strong> — το πιο στενό σημείο της μέσης, συνήθως λίγο πάνω από τον αφαλό.</li>
        <li><strong>Επιλέξτε τη γραμμή</strong> στην οποία βρίσκονται και οι δύο τιμές· αν πέφτουν σε δύο γραμμές, πάρτε το μεγαλύτερο μέγεθος.</li>
      </ol>
      <p class="kwsc-note">Μετρήστε πάνω από τα εσώρουχα, όχι πάνω από ρούχα. Η μεζούρα να εφαρμόζει, αλλά να μη σφίγγει.</p>
    </div>
  </div>
  </div>
</div>
