...
<div class="vigo-checkout-total order-total shop_table woocommerce-checkout-review-order-table">
    ...
    <div class="flex__item--autosize f--m checkout-warranty__text">
        ...
        Επιστροφή χρημάτων εντός 14 ημερών    </div>
</div>
...
<p class="ql-align-justify">Nakon predaje izjave o υπαναχώρησηu, svoje προϊόνe morate vratiti εντός 14 ημερών od datuma izjave o υπαναχώρησηu. Στείλτε τα εμπορεύματα στη διεύθυνσή μας: <strong>HS PLUS d.o.o., Poštanska ulica 25, 10410 Velika Gorica</strong>.&nbsp;Smatra se da je roba pravovremeno vraćena ako je pošaljete prije isteka roka za επιστροφή u trajanju od 14 dana.&nbsp;Morate vratiti neizmijenjenu količinu neoštećenih προϊόνa, zapakiranih u αρχική συσκευασία ili ambalažu koja προϊόνe štiti na isti način kao i originalna ambalaža. Ne μπορείte vratiti oštećene προϊόνe, προϊόνe u izmijenjenoj količini ili προϊόνe upakirane u neprikladnu ambalažu. Παρακαλούμε vratite artikle kao paketnu αποστολήu, a ne kao pismo, osiguravajući da je paket označen kodom za odustanak od αγοράς, koji ćete dobiti tijekom postupka.Ako paket nije pravilno označen (poslan bez koda za odustanak od αγοράς), to μπορεί značajno produžiti vrijeme potrebno za obradu σαςeg zahtjeva. U slučaju υπαναχώρησηa od σύμβασηa, podmirit ćete samo troškove επιστροφήa robe, s tim da se navedeni troškovi ne mogu nadoknaditi.</p>
...
<p class="ql-align-justify"><strong>U roku 14 dana od παράδοσηe μπορείte ispuniti</strong>&nbsp;obrazac na poveznici za zamjenu προϊόνa&nbsp;ili&nbsp;επιστροφή novca<strong>&nbsp;ILI&nbsp;</strong>μπορείte nas ειδοποίησηiti e-poštom o namjeri da odustajete od αγοράς.</p>
