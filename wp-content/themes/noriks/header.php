...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Formatter for Euro with 2 decimals
  ...
  function formatPrice(amount) {
    ...
    return eur.format(Math.round(amount * 100) / 100);
  }
...
<div id="page" class="hfeed site">
  ...
  <div class="marquee">
    <div class="marquee-content">
      ...
      <span><a href="/gr/shop">30 ημέρες χωρίς ρίσκο – δοκιμάστε χωρίς ανησυχία</a></span>
        ...
        <?php foreach ($header_nav as $item): ?>
            ...
            <?php if ($i === 0): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="/gr/shop">Φτιάξτε το πακέτο σας</a>
                        <a href="/gr/product-category/tricka/">Έτοιμα πακέτα</a>
                    </div>
                    -->
                </div>
            ...
            <?php elseif ($i === 1): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <!--
                    <div class="dropdown-menu">
                        <a href="/gr/product-category/boxerky-sastavi-paket/">Φτιάξτε το πακέτο σας</a>
                        <a href="/gr/product-category/boxerky/">Έτοιμα πακέτα</a>
                    </div>
                    -->
                </div>
